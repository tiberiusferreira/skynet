...
//            })
//            .flatten();
//        let augmented_data_len = data_len*5;
        use itertools::Itertools;
        let batch_size = 2;
//        while let Some(batch) = data_loader.next_batch(batch_size) {
...
//            let loss = yolo_loss::yolo_loss(desired_batch, batch_output).to_device(DEVICE);
